...
@Component({
  selector: 'app-suvidha-kendra-view',
  templateUrl: './suvidha-kendra-view.component.html',
  styleUrls: ['./suvidha-kendra-view.component.scss']
})
export class SuvidhaKendraViewComponent implements OnInit {

  active = 1;
  displayedColumns: string[] = ['patientName', 'bookingId', 'doctorName', 'appointmentTime', 'amount', 'status'];
